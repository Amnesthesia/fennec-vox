...
import type { ConversionOptions, ProgressEvent, TtsVoice, TtsModel } from '@shared/ipc';
...
const api = {
  ...
  // Voice preview
  previewVoice: (opts: { voice: TtsVoice; model: TtsModel; instructions?: string }): Promise<{ audio?: string; error?: string }> =>
