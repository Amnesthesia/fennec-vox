      ...
      switch (event.type) {
        case 'start': {
          ...
          const chapters = Array.from({ length: event.total }, (_, i) => ({
            ...
            status: (doneSet.has(i) ? 'done' : 'pending') as ChapterStatus['status'],
          }));
          return {
        ...
        <div className="setup-gate">
          <div className="setup-card">
            ...
            <p className="setup-sub">
              <b>Fennec Vox</b> uses the OpenAI API for text-to-speech synthesis.
              Paste your API key below to get started — it will be stored
        ...
        {showSettings && (
          <SettingsPanel
            onClose={() => {
              ...
              void window.api.getCredentials().then(creds => setHasOpenAiKey(!!creds.openaiKey));
            }}
          />
        )}
      </div>
      ...
      <div className="body">
        <aside className="sidebar">
          ...
          <ConversionConfig
            ...
            ttsInstructions={ttsInstructions} onTtsInstructionsChange={setTtsInstructions}
          />
          ...
          <div className="section" style={{ marginTop: 'auto', paddingTop: 12 }}>
            {convState.running ? (
              ...
              <>
                ...
                {(convState.phase === 'done' || convState.phase === 'error') && epubPath && (
                  <button
